     ...
     2                  RUNOFF,TRUNOF,OVRFLW,TOVRFL,ZPLIM,
     3                  FI,EVAP,R,TR,GZERO,G12,G23,HCP,QMELT,WSNOW,ZMAT,
     4                  TMOVE,WMOVE,ZRMDR,TADD,ZMOVE,TBOT,DELZ,
...
C
      REAL TZERO,RADD,QADD,ZMELT,GP1,HCOOL,HWARM,HFREZ,ZFREZ
C
...
C
     ...
     1                      (HCP(I,J)*DELZ(J))
              ELSEIF(J.EQ.IG)                           THEN
                  TBAR(I,J)=TBAR(I,J)+GFLUX(I,J)*DELT/
     1                      (HCP(I,J)*DELZ(J))
              ELSE
