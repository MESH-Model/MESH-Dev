PROGRAM Grid_Same_Results
!>        
!>	February 23, 2011 - B. Schweitzer
!>
!>=============================================================================
!>
!>	This program tests to see whether the Grid has produced the same results as previous
!>	runs
!>
!>=============================================================================
!>
...
!>=============================================================================
	...
	OPEN(UNIT=31,FILE='Test_Results\Grid_Same_failures.txt',STATUS='REPLACE')
	...
	ELSE
		WRITE(32,*)'Test failed ', fail, 'times for file "MESH_output_streamflow.csv".' , &
			' Check Grid_Same_failures.txt for details'
			ok = .false.
	END IF
	...
	OPEN(UNIT=11,FILE='CLASSOUT1/CLASSOF1.csv',STATUS='OLD')
	...
	OPEN(UNIT=12, FILE='CLASSOUT1/CLASSOF2.csv', STATUS='OLD')
	...
	OPEN(UNIT=13, FILE='CLASSOUT1/CLASSOF3.csv', STATUS='OLD')
	...
	OPEN(UNIT=14, FILE='CLASSOUT1/CLASSOF4.csv', STATUS='OLD')
	...
	OPEN(UNIT=15, FILE='CLASSOUT1/CLASSOF5.csv', STATUS='OLD')
	...
	OPEN(UNIT=16, FILE='CLASSOUT1/CLASSOF6.csv', STATUS='OLD')
	...
	OPEN(UNIT=17, FILE='CLASSOUT1/CLASSOF7.csv', STATUS='OLD')
	...
	OPEN(UNIT=18, FILE='CLASSOUT1/CLASSOF8.csv', STATUS='OLD')
	...
	OPEN(UNIT=19, FILE='CLASSOUT1/CLASSOF9.csv', STATUS='OLD')
