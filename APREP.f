...
C
      IF (ICTEMMOD.EQ.0) THEN
        DO 120 I=IL1,IL2
c actually you don't need "un-gathered" longitudes using I is just tinr FRANK S - Dec 2003
c            IL = ILAND(I)
            IL = I
          indx = iNT( (RADJ(IL)+PI/2.0)*180.0/PI)/10.0  + 1
