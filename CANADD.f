...
C
      REAL RTHRU,RINT,STHRU,SINT,Trncan,tsncan,RWXCES,SLOAD,SWXCES,
...
C-----------------------------------------------------------------------
     ...
     1            RAICAN(I).GT.0. .OR. SNOCAN(I).GT.0.))           THEN
              ...
              IF((RAICAN(I)+RINT).GT.0.)                 THEN
                  Trncan=(RAICAN(I)*TCAN(I)+RINT*TR(I))/(RAICAN(I)+RINT)                               
              ELSE                                                                        
                  Trncan=0.0                                                               
              ENDIF                                                                       
              IF((SNOCAN(I)+SINT).GT.0.)                 THEN 
                  tsncan=(SNOCAN(I)*TCAN(I)+SINT*TS(I))/(SNOCAN(I)+SINT)                               
              ELSE                                                                        
                  tsncan=0.0                                                               
              ENDIF                                                                       
C                                        
              ...
              IF(RWXCES.GT.0.)                           THEN 
                  ...
                  IF((RDRIP(I)+RTHRU).GT.0.)       THEN                                           
                      TR(I)=(RDRIP(I)*Trncan+RTHRU*TR(I))/
     1                      (RDRIP(I)+RTHRU)                             
                  ELSE                                                                    
                      TR(I)=0.0                                                              
                  ENDIF                                                                   
...
C
              ...
              IF(SWXCES.GT.0. .OR. SNUNLD.GT.0.)                 THEN 
                  ...
                  IF((SDRIP(I)+STHRU).GT.0.)       THEN                                           
                      TS(I)=(SDRIP(I)*tsncan+STHRU*TS(I))/
     1                      (SDRIP(I)+STHRU)                             
                  ELSE                                                                    
                      TS(I)=0.0                                                              
                  ENDIF                                                                   
...
C
              ...
              TCAN (I)=(RAICAN(I)*SPHW*Trncan+SNOCAN(I)*SPHICE*tsncan+
