     ...
     C                  FCANMX, ZOLN,   ALVSC,  ALIRC,  AILMAX, AILMIN, 
     D                  CWGTMX, ZRTMAX, RSMIN,  QA50,   VPDA,   VPDB,
     E                  PSIGA,  PSIGB,  AILDAT, HGTDAT, ACVDAT, ACIDAT, 
...
C
     ...
     A     CWLCAP(ILG),   CWFCAP(ILG),   CWLCPS(ILG),   CWFCPS(ILG),
     B     RC    (ILG),   RCS   (ILG),   
