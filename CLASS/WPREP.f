     ...
     J                 DT,     ZERO,   IZERO,  DELZZ,
     K                 FC,     FG,     FCS,    FGS,    
     L                 THLIQC, THLIQG, THICEC, THICEG, HCPC,   HCPG,
     M                 TBARC,  TBARG,  TBARCS, TBARGS, TBASE,
          ...
          DO 200 I=IL1,IL2
              IF(FCS(I).GT.0.)                                THEN 
                  ...
                  IF(THPOR(I,J).GT.0.0001)               THEN
                      GRKSCS(I,J)=GRKSAT(I,J)*(1.0-MAX(0.0,MIN(1.0,
     1                    THICCS(I,J)/THPOR(I,J))))*(1.7915E-03/
     2                    (2.0319E-04+1.5883E-03*EXP(-((MAX(0.0,
     3                    MIN(100.,TBARCS(I,J)))**0.9)/22.))))
                  ELSE
...
C
          ...
          DO 300 I=IL1,IL2
              IF(FGS(I).GT.0.)                                 THEN 
                  ...
                  HCPGS (I,J)=HCPG  (I,J)
                  IF(THPOR(I,J).GT.0.0001)               THEN
                      GRKSGS(I,J)=GRKSAT(I,J)*(1.0-MAX(0.0,MIN(1.0,
     1                    THICGS(I,J)/THPOR(I,J))))*(1.7915E-03/
     2                    (2.0319E-04+1.5883E-03*EXP(-((MAX(0.0,
     3                    MIN(100.,TBARGS(I,J)))**0.9)/22.))))
                  ELSE
...
C
          ...
          DO 400 I=IL1,IL2
              IF(FC(I).GT.0.)                                 THEN  
                  ...
                  HCPCO (I,J)=HCPC  (I,J)
                  IF(THPOR(I,J).GT.0.0001)               THEN
                      GRKSC (I,J)=GRKSAT(I,J)*(1.0-MAX(0.0,MIN(1.0,
     1                    THICCO(I,J)/THPOR(I,J))))*(1.7915E-03/
     2                    (2.0319E-04+1.5883E-03*EXP(-((MAX(0.0,
     3                    MIN(100.,TBARC(I,J)))**0.9)/22.))))
                  ELSE
...
C
          ...
          DO 500 I=IL1,IL2
              IF(FG(I).GT.0.)                                 THEN 
                  ...
                  HCPGO (I,J)=HCPG  (I,J)
                  IF(THPOR(I,J).GT.0.0001)               THEN
                      GRKSG (I,J)=GRKSAT(I,J)*(1.0-MAX(0.0,MIN(1.0,
     1                    THICGO(I,J)/THPOR(I,J))))*(1.7915E-03/
     2                    (2.0319E-04+1.5883E-03*EXP(-((MAX(0.0,
     3                    MIN(100.,TBARG(I,J)))**0.9)/22.))))
                  ELSE
