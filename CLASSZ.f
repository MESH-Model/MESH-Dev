     ...
     7                  QFC,    ROF,    WTRG,   CMAI,   rncan,   sncan,   
...
C
     ...
     A     rncan  (ILG),   sncan  (ILG),   TCAN  (ILG),   SNO   (ILG),
...
C
      DO 100 I=IL1,IL2
          WTGSTP(I)=0.0
          CTVSTP(I)=-(CMAI(I)*SPHVEG+rncan(I)*SPHW+
...
C
      DO 200 I=IL1,IL2
          CTVSTP(I)=CTVSTP(I)+(CMAI(I)*SPHVEG+rncan(I)*SPHW+
     1             sncan(I)*SPHICE)*TCAN(I)
     ...
     2             HCPSND*(DELZ(3)-DELZW(I,3)))*TBAR(I,3)
          ...
          WTVSTP(I)=WTVSTP(I)+rncan(I)+sncan(I)
...
6441          FORMAT(2X,'CANOPY ENERGY BALANCE  ',I8,2F20.8)
     ...
     1             HEVC(I),HMFC(I),HTCC(I)
              WRITE(6,6450) rncan(I),sncan(I),TCAN(I)
              STOP
          ENDIF
