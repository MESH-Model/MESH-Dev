PROGRAM Grid_Reasonable_Results
!>        
!>	March 4, 2011 - B. Schweitzer
!>
!>=============================================================================
!>
!>	This program tests to see whether the grid has produced reasonable results
!>
!>=============================================================================
!>
...
!	rof8(1,21)=0.6359;	rof8(2,21)=0;		rof8(1,22)=0;		rof8(2,22)=-12.36
	...
	OPEN(UNIT=31,FILE='Test_Results\Grid_Reasonable_failures.txt',STATUS='REPLACE')
	...
	ELSE
		WRITE(32,*)'Test failed ', fail, 'times for file "MESH_output_streamflow.csv".' , &
			' Check Grid_Reasonable_failures.txt for details'
			ok = .false.
	END IF
...
!	fail = 0
	...
	CLOSE (31)
	CLOSE (32)
END PROGRAM Grid_Reasonable_Results