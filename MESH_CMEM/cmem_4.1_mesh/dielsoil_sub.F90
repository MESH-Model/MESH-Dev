...
zcxb = (zep0b - eps_winf) / (1._JPRM + (2._JPRM*pi_cmem*f*ztaub)**2._JPRM)
zepwbx = eps_winf + zcxb
zepwby =  zcxb * (2._JPRM*pi_cmem*f*ztaub) + zsigmab / (2._JPRM*pi_cmem*eps_0*f)

zcxu = (zep0u - eps_winf) / (1._JPRM + (2._JPRM*pi_cmem*f*ztauu)**2._JPRM)
zepwux = eps_winf + zcxu
zepwuy =  zcxu * (2._JPRM*pi_cmem*f*ztauu) + zsigmau/(2._JPRM*pi_cmem*eps_0*f)
