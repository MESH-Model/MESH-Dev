...
!>  wc_thlmin, wc_bi, wc_psisat, wc_ksat, wc_hcps, wc_tcs
...
!>  wc_ksat, wc_hcps,   wc_tcs,    wc_algwet, wc_algdry
!> -----------------------------
...
!wc_ksat,wc_hcps,  wc_tcs,   wc_algwet,wc_algdry
     ...
     +    sv%wc_psisat(NA,NTYPE,IGND), sv%wc_ksat(NA,NTYPE,IGND),
...
!> *********************************************************************
      ...
      CALL READ_CHECK_FORCING_FILES(NUM_CSV, NUM_R2C)
