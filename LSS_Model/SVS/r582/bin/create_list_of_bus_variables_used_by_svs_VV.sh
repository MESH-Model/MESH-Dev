...
SVS_FULL=/users/dor/armn/vvi/Code/MESH/MESH_SVS_1/r1130.POINT_MODE/LSS_Model/SVS/r531
...
OUTFILE=$WORKDIR/list_of_bus_variables_svs_VV.txt
...
sed -e "s%'//%%g" -e "s%//'%%g" $WORKDIR/sfc_businit_SVS2.out_save | awk -F"'" '{split($1,s,",");print s[3],";",$2}' | sed -e "s/VN=//" -e "s/ON=//" -e "s/VD=//" -e "s/VS=//" -e "s/;VB=.*//" -e "s/@nm//" -e "s/;row\*/;/" -e "s/;row/;1/" -e "s/;slb/;1/" -e "s/;slc/;1/" -e "s/;nagg/;$NTILES/" -e "s/;nglp1/;12/" -e "s/;ngl/;11/" -e "s/;nstpl/;11/" -e "s/;nstel/;11/" -e "s/;ns/;12/" > $OUTFILE
