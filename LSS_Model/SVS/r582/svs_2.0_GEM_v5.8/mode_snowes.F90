...
!     snow layer(s).
!
USE MODD_CSTS_SNOWES,     ONLY : XRHOLW
...
SUBROUTINE SNOW3LAVGRAIN(PSNOWGRAN1,PSNOWGRAN2,                &
                         PSNOWGRAN1N,PSNOWGRAN2N,PNDENT,PNVIEU,&
                         HSNOWMETAMO)
!
...
! ajout EB
REAL, DIMENSION(:,:), INTENT(INOUT)  :: PSNOWGRAN1N,PSNOWGRAN2N
!
...
!
REAL, DIMENSION(SIZE(PSNOWGRAN1,1)) :: ZGRAN1, ZGRAN2
!
...
!
!
USE MODD_SNOWES_PAR,   ONLY : XSNOWCRITD,XUNDEF
!
!
IMPLICIT NONE
!
...
!
!
USE MODD_CSTS_SNOWES,     ONLY : XP00, XCONDI, XRHOLW
!
USE MODD_SNOWES_PAR, ONLY : XVRKZ6, XSNOWTHRMCOND1, &
                          XSNOWTHRMCOND2,         &
                          XSNOWTHRMCOND_AVAP,     &
                          XSNOWTHRMCOND_BVAP,     &
                          XSNOWTHRMCOND_CVAP 
...
!
USE MODD_SNOWES_PAR, ONLY : XDSGRAIN_MAX,XSNOW_AGRAIN, & 
...
!
!
USE MODD_SNOWES_PAR, ONLY : XVAGING_GLACIER, XVAGING_NOGLACIER,     &
...
!print *,'size zdiam', size(zdiam)
!print *,'zdiam', zdiam, 'sqrt', sqrt(zdiam), 'sqrt bis', sqrt(zdiam(:))
!
