!     ######################
      MODULE MODD_SNOWES_PAR
!     ######################
!
!!****  *MODD_SNOWES_PAR* - declaration of parameters related
...
!
!--------------------------------------------------------------------------------
! Parameters extracted from MODD_SNOW_METAMO for inclusion in SVS
!--------------------------------------------------------------------------------
!
...
!--------------------------------------------------------------------------------
! Parameter extracted from MODD_SURF_PAR for inclusion in SVS
!--------------------------------------------------------------------------------
