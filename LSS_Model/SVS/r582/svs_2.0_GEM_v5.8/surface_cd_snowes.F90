...
!
module surface_cd_snowES_mod

  private


  public :: surface_cd_snowES

contains

!   #################################################################
    SUBROUTINE SURFACE_CD_SNOWES(PRI, PZREF, PUREF, PZ0EFF, PZ0H,   &
                              PCD, PCDN) 
!   #################################################################
!
!!****  *SURFACE_CD*  
...
!-------------------------------------------------------------------------------
!
END SUBROUTINE SURFACE_CD_SNOWES

end module surface_cd_snowES_mod
