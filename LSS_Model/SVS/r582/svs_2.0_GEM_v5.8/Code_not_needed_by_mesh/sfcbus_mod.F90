...
#define SFCVAR(MYVAR,MYNAME) type(PHYVAR_T) :: MYVAR = PHYVAR_T(-1,0,0,0,0,.false.,MYNAME)
   ...
   type :: PHYVARLIST_T
      ...
      SFCVAR(laivh, 'laivh')
      SFCVAR(laivhen, 'laivhen')
      SFCVAR(laivl, 'laivl')
      SFCVAR(laivlen, 'laivlen')
      ...
      SFCVAR(pthrufal, 'pthrufal')
      SFCVAR(pthrufal_v, 'pthrufal_v')
      ...
      SFCVAR(slop, 'slop')
      SFCVAR(slope, 'slope')
      SFCVAR(slopen, 'slopen')
      SFCVAR(snoagen, 'snoagen')
      SFCVAR(snoage_es, 'snoage_es')
      SFCVAR(snoage_esen, 'snoage_esen')
      SFCVAR(snoage_esv, 'snoage_esv')
      SFCVAR(snoage_esven, 'snoage_esven')
      SFCVAR(snoal, 'snoal')
      ...
      SFCVAR(snogran1_es, 'snogran1_es')
      SFCVAR(snogran1_esen, 'snogran1_esen')
      SFCVAR(snogran1_esv, 'snogran1_esv')
      SFCVAR(snogran1_esven, 'snogran1_esven')
      SFCVAR(snogran2_es, 'snogran2_es')
      SFCVAR(snogran2_esen, 'snogran2_esen')
      SFCVAR(snogran2_esv, 'snogran2_esv')
      SFCVAR(snogran2_esven, 'snogran2_esven')
      SFCVAR(snoma, 'snoma')
      SFCVAR(snomaen, 'snomaen')
      SFCVAR(snoma_es, 'snoma_es')
      SFCVAR(snoma_esen, 'snoma_esen')
      SFCVAR(snoma_esv, 'snoma_esv')
      SFCVAR(snoma_esven, 'snoma_esven')
      SFCVAR(snoro, 'snoro')
      SFCVAR(snoroen, 'snoroen')
      SFCVAR(snoden_es, 'snoden_es')
      SFCVAR(snoden_esen, 'snoden_esen')
      SFCVAR(snoden_esv, 'snoden_esv')
      SFCVAR(snoden_esven, 'snoden_esven')
      ...
      SFCVAR(ssa_es,'ssa_es')
      SFCVAR(ssa_esv,'ssa_esv')
      SFCVAR(stomr, 'stomr')
      ...
      SFCVAR(tperm, 'tperm')
      SFCVAR(tpermen, 'tpermen')
      SFCVAR(tpsoil, 'tpsoil')
      SFCVAR(tpsoilen, 'tpsoilen')
      SFCVAR(tpsoilv, 'tpsoilv')
      SFCVAR(tpsoilven, 'tpsoilven')
      SFCVAR(tsa, 'tsa')
      SFCVAR(tsnavg, 'tsnavg')
      SFCVAR(tsnow, 'tsnow')
      SFCVAR(tsnowen, 'tsnowen')
      SFCVAR(tsnowveg, 'tsnowveg')
      SFCVAR(tsnowvegen, 'tsnowvegen')
      SFCVAR(tsoil, 'tsoil')
      ...
      SFCVAR(wsnow_es, 'wsnow_es')
      SFCVAR(wsnow_esen, 'wsnow_esen')
      SFCVAR(wsnow_esv, 'wsnow_esv')
      SFCVAR(wsnow_esven, 'wsnow_esven')
      SFCVAR(wsnv, 'wsnv')
      SFCVAR(wsnven, 'wsnven')
      SFCVAR(wsoil, 'wsoil')
...
!
      ...
      SFCVAR(taf,'taf')
      SFCVAR(tfigv,'tfigv')
      SFCVAR(tfnetvg,'tfnetvg')
      SFCVAR(tirgv,'tirgv')
      SFCVAR(tirvg,'tirvg')
      SFCVAR(tneige,'tneige')
      SFCVAR(trgvg,'trgvg')
      SFCVAR(trnetvg,'trnetvg')
      SFCVAR(trngv,'trngv')
      SFCVAR(vaf,'vaf')
!
