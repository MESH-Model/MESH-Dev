     ...
     2                  RHOSROW,SNOROW, TCANROW,rncanROW,sncanROW, 
     ...
     8                  RHOSGAT,SNOGAT, TCANGAT,rncangat,sncangat,
...
C
     ...
     2        SNOROW (NL,NM),    TCANROW(NL,NM),    rncanROW(NL,NM),   
     3        sncanROW(NL,NM),    GROROW (NL,NM),    TACROW (NL,NM),  
...
C
     ...
     2        SNOGAT (ILG),      TCANGAT(ILG),      rncangat(ILG),   
     3        sncangat(ILG),      GROGAT (ILG),      TACGAT (ILG),  
...
!$omp parallel do
      DO 100 K=1,NML
          ...
          rncanROW(ILMOS(K),JLMOS(K))=rncangat(K)  
          sncanROW(ILMOS(K),JLMOS(K))=sncangat(K)  
