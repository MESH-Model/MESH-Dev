...
!***********************************************************************
!       copyright (c) by Nick Kouwen 2007
!***********************************************************************
...
ccccc      MODULE area5
     ...
     *                                          yres,xres
        ...
        integer*4  noresv,local,mhto,index,nrel,noresvi,mhtoi,nreli,
     *             ktr
...
ccccc      MODULE area12
        ...
        character(200), dimension(:), allocatable :: fln
        character(200), dimension(:), allocatable :: filename
        character(200), dimension(:), allocatable :: outfln
        character(200), dimension(:), allocatable :: infln
...
ccccc      MODULE areaopts
     ...
     *       basdlt,baslow,bashgh
        ...
        real*4 :: a5dlt,a5low,a5hgh,a8dlt,a8low,a8hgh,a9dlt,a9low,
     *       a9hgh,
...
ccccc      MODULE areawet
      ...
      real*4, dimension(:), allocatable :: wetwid,chawid,
     *     chadep,qswrain,
