...
c       print *, index(header(i),":endHeader"), header(i)
      ...
      open(32,file='MESH_input_streamflow.txt')

c write header for old format streamflow file
      write(32, "(A1)") "1"
      write(32, "(4I5)") no_of_stations,9999,9999,24
      do i=1,no_of_stations
      write(32, "(2I5,1X,A20)") int(y(i)*60),int(x(i)*60.0),name_long(i)
      enddo
...
c open new format *.tb0 file
      ...
      open(31,file='19'//
     +num(year-1900)//num(month)//'01_str.tb0')
      else
      open(31,file='20'//
     +num(year-2000)//num(month)//'01_str.tb0')
      endif
