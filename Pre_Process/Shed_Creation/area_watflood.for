...
c     rev. 9.5.20  Mar.  06/08  - NK: added resvstore for iso mosed
      ...
      integer*4      ::       maxr,nl_max,nrel_max
     ...
     *                        fake,fakefs,frac,evap_convert,
     *                        grid_area,channel_area,
     *                        lake_area,lake_evaporation,
...
!       flag for calling program
     ...
     *                     scaletem,scalealltem,sstep,rdt,flowunitconv
	  logical(1)   :: keyflg,precflg,found_data_end,rd_evp_flg
...
!       these things taken out of some argument lists  nk 05/10/04
	  ...
	  integer      :: year_start,mo_start,day_start,hour_start
...
!     rev. 9.5.06  Feb.  05/08  - NK: added pool and pool_o in rdpar & route
     ...
     *                         ftalllow,ftallhgh,mndr,aa2,aa3,aa4,pool,
...
!     LAKE TRACER INFLOWS
      REAL*4, DIMENSION(:,:), ALLOCATABLE :: isolakeGW,isolakeGWst
