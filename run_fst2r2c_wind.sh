...
# Argument 2 - FST variable name for the record to be extracted - x component
varNameX=UU

# Argument 2 - FST variable name for the record to be extracted - y component
varNameY=VV
...
do
   ...
   fst2r2cV  $DIR_FILE/$FileName ${varNameX} ${varNameY} ${ip2start} ${ip2end} ${r2cName} ${cfactorm} ${cfactora} ${attrName} ${attrUnit} ${r2cFormat}
