...
!> the value at each streamgauge, as well as an average value
...
module calc_drms
    ...
    !> The model_output_drms type and calc_drms_value subroutine are accessible outside the module.
