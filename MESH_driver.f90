...
INTEGER :: IDISP, IZREF, ISLFD, IPCP, IWF, IWD, IPAI, IHGT, IALC, & !Ric Soulis added IWD
...
REAL, DIMENSION(:), ALLOCATABLE :: ZRFMGAT, ZRFHGAT, ZDMGAT, &
  ...
  TSPCGAT, RHSIGAT, FCLOGAT, DLONGAT, Z0ORGAT, GGEOGAT
!>
!>*******************************************************************
!>
!> LAND SURFACE DIAGNOSTIC VARIABLES:
...
!> DIRECT READING OF PARTITIONED PRECIPITATION (SNOWFALL AND RAINFALL)
...
WRITE(900,"('DAY,YEAR,PREACC,EVAPACC,ROFACC,ROFOACC,ROFSACC,ROFBACC,PRE,EVAP,ROF,ROFO,ROFS,ROFB,SNO,SNCAN,RCAN,ZPND,"// &
...
!
    ...
    CALL CLASSW  (THLQGAT,THICGAT,TBARGAT,TCANGAT,RCANGAT,SCANGAT, &
                  ...
                  ISNDGAT,IWF, IWD, NA*NTYPE,    1,      NML, N, & !Ric Soulis added IWD
...
9001 FORMAT('IPCP IS SPECIFIED A VALUE OF 4. THIS OPTION WHICH IS MEANT FOR DIRECT READING ', &
            'OF PARTITIONED PRECIPITATION (SNOWFALL AND RAINFALL) IS NOT YET IMPLEMENTED. ',/, &
            'CURRENTLY ONLY THE FOLLOWING THREE OPTIONS ARE AVAILABLE: ',/, &
            'IPCP = 1, THE RAINFALL-SNOWFALL CUTOFF IS TAKEN TO LIE AT 0 dC, ',/, &
            'IPCP = 2, A LINEAR PARTITIONING OF PRECIPITATION BETWEEEN ', &
