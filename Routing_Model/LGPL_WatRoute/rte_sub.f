...
!     rev. 9.?.??  Jul.  30/08  - AS: removed debug output from around the call to route
...
!     SAVES THE LOCAL VARIABLES FROM ONE RUN TO NEXT
     ...
     *                 sec_div,route_dt,hr_div
      INTEGER       :: rbin,inta,block,i,j,n,ii,
     *                 iallcnt1,n1,ii1,jan,m,ios,iallocate,
     *                 nnch,l,juold,jj,lun,nhr,nhf,
     *                 icase,iz,jz,nchr,mz,ju,mon,no_dt,
...
c      if(iopt.eq.2)print*,' In sub - back from rdflow @ 152'
...
c         print*,chaxa(n),aa2(n),aa3(n),da(n),aa4(n)
        end do
...
!       READ THE EVENT FILE - HAS TO BE DONE FOR EACH ID
        if(id.gt.1)then
          fln(99)=fln(100+id)
!         rdevtA WAS CALLED IN SPL9 FOR THE FIRST EVENT
...
!         the -1 is becasue time starts at 0.0
...
!         write reach inflow to a file intead of routing it 
...
c              dtmin=900
	        ...
	        hr_div=sec_div/3600.
              !print*,dtmin,no_dt,route_dt,sec_div,hr_div  
c             write(55,*)dtmin,ndt,rdt,sec_dt,hr_dt
!             The value of dtmin has been used to determine how many
!             times route is called. Route will determine a new dtmin
!             for the next time step.
              dtmin=3600.0
              !print*,"QI1(18) before route: ",qi1(18)   
              do n=1,no_dt
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
                call route(sec_div,hr_div,dtmin,jz,n,time,date)
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
              end do
              !print*,"QI2(18) after route: ",qi2(18)
              !print*,"QO2(18) after route: ",qo2(18)
