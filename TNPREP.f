     ...
     2                  TBAR,TCTOP,TCBOT,FI,ZPOND,TBAR1P,DELZ,
     +                  TCSNOW,ZSNOW,
...
C     * INPUT ARRAYS.
C
      REAL TBAR  (ILG, 3), TCTOP (ILG, 3), TCBOT (ILG, 3)
C
...
C
      REAL DELZ1,DELZ3,DELZ3J,A3,B3,C3,TCZERO
C
...
C
      DO 100 I=IL1,IL2
          IF(FI(I).GT.0.)                                          THEN
              ...
              DELZ3J=0.0
              DO 50 J=3,IG
                  DELZ3J=DELZ3J+DELZ(J)
                  IF(DELZ3J.LT.3.7501) DELZ3=MIN(DELZ3J,3.75)
   50         CONTINUE
...
C              A1(I)=DELZ1/(3.0*TCTOP(I,1))
C              A2(I)=DELZ1/(2.0*TCTOP(I,1))
              A3=A2(I)                                                                       
              ...
              C3=DELZ(2)/(2.0*TCBOT(I,2))+DELZ3/(3.0*TCTOP(I,3))
