     ...
     *         "percentages is greater than 100%:"
     ...
     4	        "MESH will proportionally adjust the soil percentages"
      ...
      ELSE
        ...
        READ (23,*)
        READ (23,*) (sv%wc_ksat(1,m,1),m=1,NMTEST)
        READ (23,*)
        READ (23,*) (sv%wc_ksat(1,m,2),m=1,NMTEST)
        READ (23,*)
        READ (23,*) (sv%wc_ksat(1,m,3),m=1,NMTEST)
        READ (23,*)
        ...
        DO I=1,NA
          DO M=1,NMTEST
            DO J=1,3
              ...
              sv%wc_ksat(I,M,J) = sv%wc_ksat(1,M,J)
            ...
            DO J=4,IGND
              ...
              sv%wc_ksat(I,M,J) = sv%wc_ksat(I,M,3)
