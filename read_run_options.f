...
!* If WD3 is 0, existing WATDRN1 (modified) is used.
...
!* If WD3BKFC is 0, remains unchanged at value set in wprep.f.
!* If WD3BKFC is 1, bulkfc also  remains unchanged in WATROF.
!*      WD3BKFC = 1
