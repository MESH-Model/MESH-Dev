     ...
     2wf_xx, wf_yy, wf_imax, wf_jmax, wfo_pick, NLAT, NMOS,
      ...
      if (wfo_pick(10) > 0) then
        ...
        if (MOD(wfo_pick(10) / 4, 1) /= 0) then
          do k=1,ntype
            j=j+1
            attname(j)=
     +        'GRU relative contribution to Grid Overland Flow:'
            attunits(j)='mm'
          enddo
        end if
      endif
      ...
      if (wfo_pick(22) > 0) then
        ...
        if (MOD(wfo_pick(22) / 4, 1) /= 0) then
          do k=1,ntype
            j=j+1
            attname(j)=
     +        'GRU relative contribution to Grid Soil Temp - L1:'
            attunits(j)='Celsius'
          enddo
        end if
      endif
      if (wfo_pick(23) > 0) then
        ...
        if (MOD(wfo_pick(23) / 4, 1) /= 0) then
          do k=1,ntype
            j=j+1
            attname(j)=
     +        'GRU relative contribution to Grid Soil Temp - L2:'
            attunits(j)='Celsius'
          enddo
        end if
      endif
      if (wfo_pick(24) > 0) then
        ...
        if (MOD(wfo_pick(24) / 4, 1) /= 0) then
          do k=1,ntype
            j=j+1
            attname(j)=
     +        'GRU relative contribution to Grid Soil Temp - L3:'
            attunits(j)='Celsius'
          enddo
        end if
      endif
      ...
      if (wfo_pick(26) > 0) then
        ...
        if (MOD(wfo_pick(26) / 4, 1) /= 0) then
          do k=1,ntype
            j=j+1
            attname(j)=
     +        'GRU relative contrib. to Grid Vol Liq Water - L2:'
            attunits(j)='Fraction'
          enddo
        end if
      endif
      if (wfo_pick(27) > 0) then
        ...
        if (MOD(wfo_pick(27) / 4, 1) /= 0) then
          do k=1,ntype
            j=j+1
            attname(j)=
     +        'GRU relative contrib. to Grid Vol Liq Water - L3:'
            attunits(j)='Fraction'
          enddo
        end if
      endif
