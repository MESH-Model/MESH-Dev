...
C
     ...
     V           BI, PSISAT, DD, XSLOPE, BULK_FC,THLMIN  )
C
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLMCS,XSLOPE,XDRAINH,MANNING_N,DD,GRKSCS,TBRWCS,
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLMGS,XSLOPE,XDRAINH,MANNING_N,DD,GRKSGS,TBRWGS,
     3                DELZW,THPOR,THLMIN,BI,DODRN,DOVER,DIDRN,
     4                ISAND,IWF,IG,ILG,IL1,IL2,BULK_FC,
     6                NA,NTYPE,ILMOS,JLMOS)
          ENDIF
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLIMC,XSLOPE,XDRAINH,MANNING_N,DD,GRKSC,TBARWC,
     3                DELZW,THPOR,THLMIN,BI,DODRN,DOVER,DIDRN,
     4                ISAND,IWF,IG,ILG,IL1,IL2,BULK_FC,
     6                NA,NTYPE,ILMOS,JLMOS)
          ENDIF
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLIMG,XSLOPE,XDRAINH,MANNING_N,DD,GRKSG,TBARWG,
     3                DELZW,THPOR,THLMIN,BI,DODRN,DOVER,DIDRN,
     4                ISAND,IWF,IG,ILG,IL1,IL2,BULK_FC,
     6                NA,NTYPE,ILMOS,JLMOS)
          ENDIF
