...
*FOR WATDRN3
     ...
     9                 BTC,BCAP,DCOEFF,BFCAP,BFCOEFF,BFMIN,BQMAX,SDEPTH) !Ric Soulis added SDEPTH
C                                                                        
...
C
     ...
     1  BFMIN,BQMAX,SDEPTH                                              !Ric added SDEPTH
...
C
     ...
     V           BI, PSISAT, DDEN, XSLOPE, BULKFC  )
C
...
!Ric Soulis changed XDRAINH to XDRAIN, added XDRAINH as RATIO
     ...
     6                NA,NTYPE,ILMOS,JLMOS,SDEPTH,RATIOQ)
