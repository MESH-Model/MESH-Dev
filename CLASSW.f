...
C
     ...
     3     TRUNOF(ILG),    WSNOW (ILG),    dden(ilg)
C
C     * DIAGNOSTIC ARRAYS.
C
...
C
     ...
     1     ksat(ILG,IG),PSISAT(ILG,IG),THLRAT(ILG,IG),
     2     THFC  (ILG,IG),HCPS  (ILG,IG),DELZW (ILG,IG),DELZZ (ILG,IG),
     3     ZBOTW (ILG,IG),XDRAIN(ILG),   XSLOPE(ILG), xdrndum(ilg),   
     4     WFSURF(ILG),   DELZ  (IG),
     5     bulkfc(ilg,ig),satfc(ILG,IG),H
C
...
C
      INTEGER             LZFAV (ILG)
       ...
       REAL, DIMENSION(ilg,ig) :: DCOEFF,BFCOEFF

      REAL, DIMENSION(ILG,ig) :: GRKEFF

c      real, DIMENSION(IG) :: QHAT,BFHAT
      REAL  QFLOW,BFLOW,TOL,btc,bfc
C
...
C
     ...
     2                TCGLAC,CLHMLT,CLHVAP
      ...
      REAL    BCAP,BFCAP,BFMIN,BQMAX,B(ILG,IG)  
...
C
     ...
     S           THPOR,  HCPS,   ksat, ISAND,  DELZW,  DELZ,
     T           ILG,    IL1,    IL2,    JL,     IG,     IGP1,
     U           NLANDCS,NLANDGS,NLANDC, NLANDG, RADD,   SADD,
     V           b, PSISAT, DDEN, XSLOPE, bulkfc,satfc  )
...
C
     ...
     1                HCPSCS,HTCS,FCS,S PCCS,TSPCCS,RHOSNI,WSNOCS,
     2                ILG,IL1,IL2,JL)
     ...
     9                THPOR,THLRET,THLMIN,b,PSISAT,GRKSCS,
     ...
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
          CALL grdran(1,1,THLQCS,THICCS,TBRWCS,
     a                ovrflw,tovrfl,subflw,tsubfl,FDUMMY,TDUMMY,
     1                BASFLW,TBASFL,RUNFCS,TRNFCS,
     2                QFG,WLSTCS,FCS,EVPCSG,RPCCS,ZPNDCS,
     3                DT,WEXCES,THLMAX,THTEST,THPOR,THLRET,THLMIN,
     4                b,PSISAT,GRKSCS,THFC,DELZW,XDRAIN,ISAND,
     5                IZERO,IGRN,IGRD,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
!Craig Thompson added call to watrof, june 2008.
c          CALL WATROF(THLQCS,THICCS,ZPNDCS,TPNDCS,OVRFLW,TOVRFL,
c     1                SUBFLW,TSUBFL,RUNFCS,TRNFCS,FCS,ZPLMCS,
c     2                XSLOPE,xdrain,MANNING_N,DD,KSAT,TBRWCS,
c     3                DELZW,THPOR,THLMIN,b,DODRN,DOVER,DIDRN,
cc     4                ISAND,IWF,IG,ILG,IL1,IL2,bulkfc,satfc,
c     6                NA,NTYPE,ILMOS,JLMOS,
c     7                BTC,BCAP,DCOEFF,BFCAP,BFCOEFF,BFMIN,BQMAX)
...
C
     ...
     7                ZERO,WEXCES,FDTBND,WADD,TADD,WADJ,TIMPND,
     8                DZF,DTFLOW,THLNLZ,THLQLZ,DZDISP,WDISP,WABS,
     9                THPOR,THLRET,THLMIN,b,PSISAT,GRKSGS,
     A                THLRAT,THFC,DELZW,ZBOTW,XDRAIN,ISAND,IGRN,
     B                IGRD,IFILL,IZERO,LZF,NINF,IFIND,ITER,
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
          CALL grdran(1,2,THLQGS,THICGS,TBRWGS,
     a                ovrflw,tovrfl,subflw,tsubfl,FDUMMY,TDUMMY,
     1                BASFLW,TBASFL,RUNFGS,TRNFGS,
     2                QFG,WLSTGS,FGS,EVAPGS,RPCGS,ZPNDGS,
     3                DT,WEXCES,THLMAX,THTEST,THPOR,THLRET,THLMIN,
     4                b,PSISAT,GRKSGS,THFC,DELZW,XDRAIN,ISAND,
     5                IZERO,IGRN,IGRD,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
!Craig Thompson added call to watrof, june 2008.
c          CALL WATROF(THLQGS,THICGS,ZPNDGS,TPNDGS,OVRFLW,TOVRFL,
c     1                SUBFLW,TSUBFL,RUNFGS,TRNFGS,FGS,ZPLMGS,
c     2                XSLOPE,xdrain,MANNING_N,DD,KSAT,TBRWGS,
c     3                DELZW,THPOR,THLMIN,b,DODRN,DOVER,DIDRN,
c     4                ISAND,IWF,IG,ILG,IL1,IL2,bulkfc,satfc,
c     6                NA,NTYPE,ILMOS,JLMOS,
c     7                BTC,BCAP,DCOEFF,BFCAP,BFCOEFF,BFMIN,BQMAX)
...
C
     ...
     7                ZERO,WEXCES,FDTBND,WADD,TADD,WADJ,TIMPND,
     8                DZF,DTFLOW,THLNLZ,THLQLZ,DZDISP,WDISP,WABS,
     9                THPOR,THLRET,THLMIN,b,PSISAT,GRKSC,
     A                THLRAT,THFC,DELZW,ZBOTW,XDRAIN,ISAND,IGRN,
     B                IGRD,IFILL,IZERO,LZF,NINF,IFIND,ITER,
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
          CALL grdran(1,3,THLQCO,THICCO,TBARWC,
     a                ovrflw,tovrfl,subflw,tsubfl,FDUMMY,TDUMMY,
     1                BASFLW,TBASFL,RUNFC,TRUNFC,
     2                QFG,WLOSTC,FC,EVAPCG,RPCC,ZPONDC,
     3                DT,WEXCES,THLMAX,THTEST,THPOR,THLRET,THLMIN,
     4                b,PSISAT,GRKSC,THFC,DELZW,XDRAIN,ISAND,
     5                IZERO,IGRN,IGRD,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
!Craig Thompson added call to watrof, june 2008.
c          CALL WATROF(THLQCO,THICCO,ZPONDC,TPONDC,OVRFLW,TOVRFL,
c     1                SUBFLW,TSUBFL,RUNFC,TRUNFC,FC,ZPLIMC,
c     2                XSLOPE,xdrain,MANNING_N,DD,KSAT,TBARWC,
c     3                DELZW,THPOR,THLMIN,b,DODRN,DOVER,DIDRN,
c     4                ISAND,IWF,IG,ILG,IL1,IL2,bulkfc,satfc,
c     6                NA,NTYPE,ILMOS,JLMOS,
c     7                BTC,BCAP,DCOEFF,BFCAP,BFCOEFF,BFMIN,BQMAX)
...
C
     ...
     7                ZERO,WEXCES,FDTBND,WADD,TADD,WADJ,TIMPND,
     8                DZF,DTFLOW,THLNLZ,THLQLZ,DZDISP,WDISP,WABS,
     9                THPOR,THLRET,THLMIN,b,PSISAT,GRKSG,
     A                THLRAT,THFC,DELZW,ZBOTW,XDRAIN,ISAND,IGRN,
     B                IGRD,IFILL,IZERO,LZF,NINF,IFIND,ITER,
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
          CALL grdran(1,4,THLQGO,THICGO,TBARWG,
     a                ovrflw,tovrfl,subflw,tsubfl,FDUMMY,TDUMMY,
     1                BASFLW,TBASFL,RUNFG,TRUNFG,
     2                QFG,WLOSTG,FG,EVAPG,RPCG,ZPONDG,
     3                DT,WEXCES,THLMAX,THTEST,THPOR,THLRET,THLMIN,
     4                b,PSISAT,GRKSG,THFC,DELZW,XDRAIN,ISAND,
     5                IZERO,IGRN,IGRD,IG,IGP1,IGP2,ILG,IL1,IL2,JL,N)
!Craig Thompson added call to watrof, june 2008.
c          CALL WATROF(THLQGO,THICGO,ZPONDG,TPONDG,OVRFLW,TOVRFL,
c     1                SUBFLW,TSUBFL,RUNFG,TRUNFG,FG,ZPLIMG,
c     2                XSLOPE,xdrain,MANNING_N,DD,KSAT,TBARWG,
c     3                DELZW,THPOR,THLMIN,b,DODRN,DOVER,DIDRN,
c     4                ISAND,IWF,IG,ILG,IL1,IL2,bulkfcc,satfc,
c     6                NA,NTYPE,ILMOS,JLMOS,
c     7                BTC,BCAP,DCOEFF,BFCAP,BFCOEFF,BFMIN,BQMAX)
