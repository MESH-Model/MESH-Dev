     ...
     R                  NLANDCS,NLANDGS,NLANDC, NLANDG,NLANDI,MANNING_N,
     S                  DD,     GRKSATH )
C                                                                        
...
C
     ...
     1     THIDUM(ILG,IG),     TDUMW (ILG,IG),     GRKTLD(ILG,IG)
C
...
C
     ...
     K           DT,     ZERO,   IZERO,  DELZZ,
     L           FC,     FG,     FCS,    FGS,    
     M           THLIQC, THLIQG, THICEC, THICEG, HCPC,   HCPG,
     N           TBARC,  TBARG,  TBARCS, TBARGS, TBASE,
...
C
     ...
     9                THPOR,THLRET,THLMIN,BI,PSISAT,GRKSCS,GRKTLD,
     ...
     4                G23CS,GGEO,TA,WSNOCS,TCTOP,TCBOT,GFLXCS,
...
C
     ...
     1                    HCPSGS,ALBSGS,HMFG,HTCS,HTC,WTRS,WTRG,
     2                    GFLXGS,RUNFGS,TRNFGS,OVRFLW,TOVRFL,ZPLMGS,
     ...
     7                ZERO,WEXCES,FDTBND,WADD,TADD,WADJ,TIMPND,
     8                DZF,DTFLOW,THLNLZ,THLQLZ,DZDISP,WDISP,WABS,
     9                THPOR,THLRET,THLMIN,BI,PSISAT,GRKSGS,GRKTLD,
     A                THLRAT,THFC,DELZW,ZBOTW,XDRAIN,ISAND,IGRN,
     B                IGRD,IFILL,IZERO,LZF,NINF,IFIND,ITER,
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,
     D                GRKFAC,GRKSATH,XSLOPE,DD  )
     ...
     4                G23GS,GGEO,TA,WSNOGS,TCTOP,TCBOT,GFLXGS,
...
C
     ...
     7                ZERO,WEXCES,FDTBND,WADD,TADD,WADJ,TIMPND,
     8                DZF,DTFLOW,THLNLZ,THLQLZ,DZDISP,WDISP,WABS,
     9                THPOR,THLRET,THLMIN,BI,PSISAT,GRKSC,GRKTLD,
     A                THLRAT,THFC,DELZW,ZBOTW,XDRAIN,ISAND,IGRN,
     B                IGRD,IFILL,IZERO,LZF,NINF,IFIND,ITER,
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,
     D                GRKFAC,GRKSATH,XSLOPE,DD  )
     ...
     4                G23C,GGEO,TA,ZERO,TCTOP,TCBOT,GFLXC,
...
C
     ...
     1                    HCPSG,ALBSG,HMFG,HTCS,HTC,WTRS,WTRG,
     2                    GFLXG,RUNFG,TRUNFG,OVRFLW,TOVRFL,ZPLIMG,
     ...
     7                ZERO,WEXCES,FDTBND,WADD,TADD,WADJ,TIMPND,
     8                DZF,DTFLOW,THLNLZ,THLQLZ,DZDISP,WDISP,WABS,
     9                THPOR,THLRET,THLMIN,BI,PSISAT,GRKSG,GRKTLD,
     A                THLRAT,THFC,DELZW,ZBOTW,XDRAIN,ISAND,IGRN,
     B                IGRD,IFILL,IZERO,LZF,NINF,IFIND,ITER,
     C                NEND,ISIMP,IG,IGP1,IGP2,ILG,IL1,IL2,JL,
     D                GRKFAC,GRKSATH,XSLOPE,DD   )
     ...
     4                G23G,GGEO,TA,ZERO,TCTOP,TCBOT,GFLXG,
