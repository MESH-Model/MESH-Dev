     ...
     P                  ISAND,  IWF, IWD, ILG,    IL1,    IL2,    N, !Ric Soulis added IWD
...
*FOR WATDRN3
     8                  NA,NTYPE,ILMOS,JLMOS,RATIOQ,                     !Ric Soulis added RATIOQ
     9                  BTC,BCAP,DCOEFF,BFCAP,BFCOEFF,BFMIN,BQMAX,ICLAY) !Ric Soulis added ICLAY
C                                                                        
...
C     * JUL 08/04 - D.VERSEGHY. NEW LOWER LIMITS FOR RCAN, SNCAN, ZPOND
C     *                         AND SNOW.
...
C
     ...
     1        NLANDC,NLANDG,NLANDI,IPTBAD,JPTBAD,KPTBAD,LPTBAD,N,IWD !Ric Soulis added IWD
C
...
C
     ...
     4     WFSURF(ILG),   KSAT(ILG),   DELZ  (IG), BULKFC(ILG,IG)
C
      INTEGER             ISAND(ILG,IG),ICLAY(ILG,IG)                     !RIC SOULIS ADDED ICLAY
C
...
C     * WATDRN3
      INTEGER :: NA,NTYPE
      REAL    RATIOQ(ILG)                                              !Ric Soulis added RATIOQ
...
C
     ...
     V           BI, PSISAT, DDEN, XSLOPE, BULKFC, iclay  )               !RIC ADDED ICLAY
C
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLMGS,XSLOPE,XDRAIN,MANNING_N,DDEN,GRKSGS,TBRWGS,
     3                DELZW,THPOR,THLMIN,BI,DODRN,DOVER,DIDRN,
     4                ISAND,ICLAY,IWF,IWD,IG,ILG,IL1,IL2,BULKFC,
     6                NA,NTYPE,ILMOS,JLMOS,RATIOQ)
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLIMC,XSLOPE,XDRAIN,MANNING_N,DDEN,GRKSC,TBARWC,
     3                DELZW,THPOR,THLMIN,BI,DODRN,DOVER,DIDRN,
     4                ISAND,ICLAY,IWF,IWD,IG,ILG,IL1,IL2,BULKFC,
     6                NA,NTYPE,ILMOS,JLMOS,RATIOQ)
...
!Craig Thompson added call to watrof, june 2008.
     ...
     2                ZPLIMG,XSLOPE,XDRAIN,MANNING_N,DDEN,GRKSG,TBARWG,
     3                DELZW,THPOR,THLMIN,BI,DODRN,DOVER,DIDRN,
     4                ISAND,ICLAY,IWF,IWD,IG,ILG,IL1,IL2,BULKFC,
     6                NA,NTYPE,ILMOS,JLMOS,RATIOQ)
