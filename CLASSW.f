...
C
     ...
     5        CUMSNOWINFILGS(ILG)
      REAL    t0_ACC, SOIL_POR_MAX, SOIL_DEPTH, S0, T_ICE_LENS, RATIO !Ric Soulis added SOIL_DEPTH and RATIO
...
C     * PREPARATION.
C
      RATIO = 1.0      !Ric Soulis added this
      SOIL_DEPTH = 3.5 !Ric Soulis added this
...
!Craig Thompson added call to watrof, june 2008.
     ...
     6                NA,NTYPE,ILMOS,JLMOS,SOIL_DEPTH,RATIO)
