...
! 5  Vegetation water content (Jackson vegetation model)
!    ------------------------
...
! 6 Vegetation b1 and b2 parameter (Wigneron's vegetation model- replace b and VWC in Jackson)
! Updated from Grant et al. (2007) and Wigneron et al. (2007)
!
Zb1(0)=0.0       ! no veg
...
!   following Wigneron et al., 2007 and Grant et al., (2007)
...
! Grant et al. (2007) and  Wigneron et al., 2007
...
! 9 Empirical roughness parameter for Wigneron's 2007 parameterization 
