...
! 
! Reference:
!  T.T. Wilheit, 1978: Radiative transfer in a plane stratified dielectric,
!    IEEE Transactions Geoscience Electronics, Vol. GE-16, No. 2, 138-143.
!---------------------------------------------------------------------------

USE PARKIND1  ,ONLY : JPIM,JPRM
USE YOMCMEMPAR, ONLY : theta , nlay_soil_mw, lamcm, c, pi_cmem, LGPRINT
...
thrad = theta * pi_cmem / 180.   ! incidence angle (degrees to radians)
...
USE PARKIND1  ,ONLY : JPIM,JPRM
USE YOMCMEMPAR ,ONLY : lamcm , pi_cmem, LGPRINT
...
COMPLEX(KIND = JPRM) :: CS, CC, CARG
COMPLEX(KIND = JPRM) :: CSJ, CCJ, CSJP1, CCJP1, CA, CB, CX, CXP
COMPLEX(KIND = JPRM) :: CN(N), CP(N), CEP(N), CEM(N)
!---------------------------------------------------------------------------
...
REAL(KIND = JPRM) :: R, S, ARG, E2, DP, X
COMPLEX(KIND = JPRM) :: CS, CC, CARG
COMPLEX(KIND = JPRM) :: CSJ, CCJ, CSJP1, CCJP1, CD, CA, CB, CR, CX, CXP
COMPLEX(KIND = JPRM) :: CN(N), CP(N), CEP(N), CEM(N)
!---------------------------------------------------------------------------
