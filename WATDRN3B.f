...
C
      SUBROUTINE WATDRN3B (PSISAT,THPOR,GRKSAT,BI,XSLOPE,dden,
     1  NA,NTYPE,IGND,
...
C
     ...
     1  SAND,CLAY
      REAL, DIMENSION(NA,NTYPE) :: XSLOPE,dden
C
C     *****************************************************************
...
*     1      XSLOPE(1,M),1/(2*dden(1,M)),PSISAT(1,M,J),THPOR(1,M,J),
     1      XSLOPE(1,M),dden(1,M),PSISAT(1,M,J),THPOR(1,M,J),
