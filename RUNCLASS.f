...
C     * OPEN FILES FOR READING AND WRITING.
      ...
      OPEN(UNIT=23,FILE='hydrology.ini',STATUS='OLD')
...
C     * FIRST, MODEL RUN SPECIFICATIONS.
      ...
      WRITE(61,6011) 
6011  FORMAT(2X,'IDAY,IYEAR,FSSTAR,FLSTAR,QH,QE,SNOMLT,BEG,GTOUT,
...
6616      FORMAT(2X,'HOUR  MIN  DAY  SWIN  LWIN  PCP  TA  VA  PA  QA')
      ...
      WRITE(67,6017)
6017  FORMAT(2X,'TROFROW(I,M),TROOROW(I,M),TROSROW(I,M),TROBROW(I,M),
     1ROFROW(I,M),ROFOROW(I,M),ROFSROW(I,M),ROFBROW(I,M),FCS(I),FGS(I),
     2FC(I),FG(I)')
...
C     * READ d100 and ponding limits
      read (23,*)
      DO I=1,NLTEST
      DO M=1,NMTEST
...
6900  FORMAT(2X,21(E12.4,2X))
     ...
     3                   TPN,ZPNDROW(I,M)
          WRITE(65,6500) IHOUR,IMIN,IDAY,IYEAR,(TBARROW(I,M,J)-TFREZ,
     1                   THLQROW(I,M,J),THICROW(I,M,J),J=1,3),
     2                   TCN,RCANROW(I,M),SCANROW(I,M),TSN,ZSN
          WRITE(66,6601) IHOUR,IMIN,IDAY,FSDOWN,FDLGRD(I),PREGRD(I),
...
725       CONTINUE
     ...
     2                       TCN,RCANACC(I),SCANACC(I),TSN,ZSN
              WRITE(63,6301) IDAY,IYEAR,FSINACC(I),FLINACC(I),
