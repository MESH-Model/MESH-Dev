...
C
     ...
     2              LAMXROW(NL,NM,IC),   LAMNROW(NL,NM,IC),
...
C
     ...
     7              AILDGAT(ILG,IC),     HGTDGAT(ILG,IC),
...
C
      DO 400 L=1,IC
      DO 400 K=1,NML
          LAMXGAT(K,L)=LAMXROW(ILMOS(K),JLMOS(K),L)
          LAMNGAT(K,L)=LAMNROW(ILMOS(K),JLMOS(K),L)
          ...
          AILDGAT(K,L)=AILDROW(ILMOS(K),JLMOS(K),L)
