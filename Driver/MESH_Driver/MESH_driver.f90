...
DO I=1,NA
  DO M=1,NMTEST
    ...
    ZPNDACC(I)=ZPNDACC(I)+cp%ZPNDROW(I,M)*cp%FAREROW(I,M)
    DO J=1,IGND
...
!> update components for final tally
    ...
    DO J = 1, IGND
      TOTAL_THLQ(J)= TOTAL_THLQ(J) + THLQACC(I,J)
      TOTAL_THIC(J)= TOTAL_THIC(J) + THICACC(I,J)
    ENDDO
    TOTAL_ZPND    = TOTAL_ZPND    + ZPNDACC(I)
