...
!> ANDY *    INTEGER, PARAMETER :: M_G = 5
    character(24) :: VERSION = 'TRUNK (872)'
...
!* bi%xCount: NUMBER OF GRID SQUARES IN X-DIRECTION OF
!*                      BASIN (COLUMNS) (JMAX)
!* bi%yCount: NUMBER OF GRID SQUARES IN Y-DIRECTION OF
!*                      BASIN (ROWS) (IMAX)
!* bi%AL: SINGLE GRID SIDE LENGTH IN METRES (AL)
!* bi%NA: NUMBER OF GRID SQUARES IN BASIN (WF_NA)
!* bi%NAA: NUMBER OF GRID SQUARE OUTLETS IN BASIN (NAA)
!* bi%NTYPE: NUMBER OF GRUS (WF_NTYPE)
!* bi%FRAC: GRID FRACTION (previously WF_FRAC)
!* bi%ACLASS: PERCENT-GRU FRACTION FOR EACH GRID SQUARE
...
!* bi%Zone: CO-ORDINATE SYSTEM (FROM BASIN SHD FILE)
!*                   (PASSED TO WRITE_R2C)
!* bi%Datum: CO-ORDINATE SYSTEM (FROM BASIN SHD FILE)
!*                     (PASSED TO WRITE_R2C)
!* bi%xOrigin: X-DIRECTION CO-ORDINATE OF BASIN GRID
!*                        (FROM BASIN SHD FILE) (PASSED TO
!*                        WRITE_R2C)
!* bi%yOrigin: Y-DIRECTION CO-ORDINATE OF BASIN GRID
!*                        (FROM BASIN SHD FILE) (PASSED TO
!*                        WRITE_R2C)
!* bi%xDelta: AVERAGE DIFFERENCE BETWEEN TWO X-DIRECTION
!*                      SIDES OF GRID SQUARE (FROM BASIN SHD FILE)
!*                      (PASSED TO WRITE_R2C)
!* bi%yDelta: AVERAGE DIFFERENCE BETWEEN TWO Y-DIRECTION
!*                      SIDES OF GRID SQUARE (FROM BASIN SHD FILE)
!*                      (PASSED TO WRITE_R2C)
...
!* bi%yyy: Y-DIRECTION GRID SQUARE CO-ORDINATE (YYY), aka column coordinate
!* bi%xxx: X-DIRECTION GRID SQUARE CO-ORDIANTE (XXX), aka row coordinate
