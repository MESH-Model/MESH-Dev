...
REAL*4, DIMENSION(:, :), ALLOCATABLE :: RUNOFF, RECHARGE,LEAKAGE2
...
ALLOCATE (OUTARRAY(YCOUNT, XCOUNT), RUNOFF(YCOUNT, XCOUNT), &
  RECHARGE(YCOUNT, XCOUNT),LEAKAGE2(YCOUNT,XCOUNT), STAT=PAS)
IF (PAS .NE. 0) THEN
  WRITE (6, *)
  WRITE (6, *)
...
CALL tile_connector(runoff, recharge, leakage2, ncount, ROFOGRD, ROFSGRD, ROFBGRD, DELT)
