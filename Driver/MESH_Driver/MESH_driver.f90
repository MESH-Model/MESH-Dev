...
REAL    SAE,SAESRT,FBEST,FTEST,QOBS(NCALMAX),QSIM(NCALMAX)
...
IF (IMIN == 60) THEN
  ...
  IF (IHOUR==24) THEN
    ...
    IF(PREEMPTIONFLAG .GE. 1)THEN
      IF(OBJFNFLAG == 0)THEN
         FTEST = SAE(QOBS(1:NCAL),QSIM(1:NCAL),NCAL,PREEMPTIONFLAG)
      ELSEIF(OBJFNFLAG == 1)THEN
         FTEST = SAESRT(QOBS(1:NCAL),QSIM(1:NCAL),NCAL,PREEMPTIONFLAG)
      ENDIF
