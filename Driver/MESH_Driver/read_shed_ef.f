...
CDAN      print*,'avant call initshedparam'
      IF(IOPT .EQ. 2) PRINT *, 'avant call initshedparam'
...
CDAN      print*,'in read_shed_ef with',unitNum,flnNum
      IF(IOPT .EQ. 2) PRINT *, 'in read_shed_ef with', UNITNUM, FLNNUM
...
CDAN      print*,'avant calling program flg,328'
      IF(IOPT .EQ. 2) PRINT *, 'avant calling program flg, 328'
...
CDAN      if(imax.le.7.and.jmax.le.7.and.na.le.15.and.al.le.2000.0)then
      if(IMAXI.le.7.and.JMAXI.le.7.and.na.le.15.and.al.le.2000.0)then
