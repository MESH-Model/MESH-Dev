...
subroutine read_abstractionpoint_tb0(shd, iun, fname)
    ...
    call get_keyword_value(iun, fname, vkeyword, nkeyword, ':MinStorage', fms%absp%smin, fms%absp%n, ierr, verbose)
    call get_keyword_value(iun, fname, vkeyword, nkeyword, ':MinfracStorage', fms%absp%fsmin, fms%absp%n, ierr, verbose)
    call get_keyword_value(iun, fname, vkeyword, nkeyword, ':MinLevel', fms%absp%zlvl0, fms%absp%n, ierr, verbose)
