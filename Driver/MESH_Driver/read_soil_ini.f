...
!> *********************************************************************
     ...
     &	         'MESH will proportionally adjust the soil percentages'
      ...
      read(iun, *)
      read(iun, *) (pm_gru%slp%thpor(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thpor(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thpor(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thlret(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thlret(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thlret(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thlmin(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thlmin(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%thlmin(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%bi(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%bi(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%bi(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%psisat(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%psisat(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%psisat(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%grksat(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%grksat(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%grksat(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%hcps(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%hcps(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%hcps(m, 3), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%tcs(m, 1), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%tcs(m, 2), m = 1, NTYPE)
      read(iun, *)
      read(iun, *) (pm_gru%slp%tcs(m, 3), m = 1, NTYPE)
