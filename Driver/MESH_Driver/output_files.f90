    ...
    subroutine output_files_init(fls, shd)
        ...
        do while (ios == 0)
            ...
            select case (args(1))
                ...
                case (VN_FSNET)
                    call output_files_append_field(fls, shd, ts, VN_FSNET, args, nargs, z)
                case (VN_FLIN, 'FDL')
                    call output_files_append_field(fls, shd, ts, VN_FLIN, args, nargs, z)
                case (VN_FLNET)
                    call output_files_append_field(fls, shd, ts, VN_FLNET, args, nargs, z)
                case (VN_TA)
                ...
                case (VN_CMAI)
                    call output_files_append_field(fls, shd, ts, VN_CMAI, args, nargs, z)
                case (VN_TCAN)
