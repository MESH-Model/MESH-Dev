...
module model_variables
    ...
    type model_variables_fields
        ...
        !* rcan: Liquid water interception in the canopy. [kg m**-2].
        !* sncan: Frozen water interception in the canopy. [kg m**-2].
        !* cmas: Organic mass of the canopy. [kg m**-2].
        !* tac: Air temperature in the canopy. [K].
        !* qac: Specific humidity of air in the canopy. [kg kg**-1].
        ...
        !* albs: Snow albedo.
        !* wsno: Liquid water content of the snow. [kg m-2].
        !* tsno: Snowpack temperature. [K].
        !* rofsno: Drainage from the bottom of the snowpack (runoff rate). [kg m-2 s-1].
        ...
        !* rofs: Interflow runoff rate. [kg m-2 s-1].
        !* delzw: Permeable thickness of the soil layer. [m].
        !* zbotw: Permeable depth of the soil layer. [m].
        !* rofb: Drainage from the bottom of the permeable soil column (runoff rate). [kg m**-2 s**-1].
        ...
        !* ab: Storage abstracted from a routing element. [m**3].
