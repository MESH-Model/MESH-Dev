SUBROUTINE WRITE_R2C_DATA(NML,NLTEST,NMTEST,NCOUNT,IMIN,ACLASS, &
                          ...
                          GRDGAT,R2C_ATTRIBUTES,FRAME_NO,YY, &
...
!>COLLECT OUTPUT DATA
CALL R2C_DATA(DATAIN,DATAOUT,NML,NLTEST,NMTEST,NCOUNT,R2CFILEUNITSTART, &
...
DO N = 1, NR2C
   IF(GRD(N) == 1)THEN
      ...
      WRITE(FILECOUNT,9000)':Frame',FRAME_NO,FRAME_NO,YY,MM,DD,HH,MI
      DO J = 1, YCOUNT
         WRITE(FILECOUNT,'(999(F12.6))')(DATAOUT(FILECOUNT,I,J),I=1,XCOUNT)
      ENDDO
      WRITE(FILECOUNT,'(A)')':EndFrame'
   ENDIF
