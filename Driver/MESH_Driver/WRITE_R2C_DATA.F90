SUBROUTINE WRITE_R2C_DATA(NML,NLTEST,NMTEST,NCOUNT,IMIN,ACLASS, &
                          ...
                          FRAME_NO,YY,MM,DD,HH,MI,IC,ICP1,IG, &
...
REAL DATAIN(ILG),DATAOUT(50,XCOUNT,YCOUNT),DATAOUT2(XCOUNT,YCOUNT)
...
INTEGER FILECOUNT,  FILECAP

!>COLLECT OUTPUT DATA
CALL R2C_DATA(DATAIN,DATAOUT,NML,NLTEST,NMTEST,NCOUNT,IMIN,ACLASS,NR2C,GRD,GAT,GRDGAT, &
...
DO N = 1, NR2C
   IF(GRD(N) == 1)THEN
      ...
      WRITE(FILECOUNT + FILECAP,9000)':Frame',FRAME_NO,FRAME_NO,YY,MM,DD,HH,MI
      DO J = 1, YCOUNT
         WRITE(FILECOUNT + FILECAP,'(100(F12.6))')(DATAOUT(FILECOUNT,I,J),I=1,XCOUNT)
      ENDDO
      WRITE(FILECOUNT + FILECAP,'(A)')':EndFrame'
